...
namespace VRStandardAssets.Menu
{
    ...
    public class GoOtherScene : MonoBehaviour
    {
        public event Action<GoOtherScene> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
